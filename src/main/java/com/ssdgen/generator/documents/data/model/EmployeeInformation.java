...
public class EmployeeInformation {
    ...
    public EmployeeInformation(String employeCode, String registrationNumber, String socialSecurityNumber,
            String assignment,
    ...
    public static class Generator implements ModelGenerator<EmployeeInformation> {
        ...
        private static final String DepartCommFile = "payslips/employee/commonCodeInsee.json";
        {
            Reader jsonReader = new InputStreamReader(
                    EmployeeInformation.class.getClassLoader().getResourceAsStream(DepartCommFile));
            Gson gson = new Gson();
            Type collectionType = new TypeToken<Collection<DepartCommune>>() {
            }.getType();
        ...
        {
            Reader jsonReader = new InputStreamReader(
                    EmployeeInformation.class.getClassLoader().getResourceAsStream(CategoriesEmpFile));
            Gson gson = new Gson();
            Type collectionType = new TypeToken<Collection<CategoryEmployee>>() {
            }.getType();
        ...
        {
            Reader jsonReader = new InputStreamReader(
                    EmployeeInformation.class.getClassLoader().getResourceAsStream(CategoriesCoefFile));
            Gson gson = new Gson();
            Type collectionType = new TypeToken<Collection<CategorieCoef>>() {
            }.getType();
        ...
        {
            Reader jsonReader = new InputStreamReader(
                    EmployeeInformation.class.getClassLoader().getResourceAsStream(ConvCollFile));
            Gson gson = new Gson();
            Type collectionType = new TypeToken<Collection<ConventionCollec>>() {
            }.getType();
        ...
        {
            Reader jsonReader = new InputStreamReader(
                    EmployeeInformation.class.getClassLoader().getResourceAsStream(CoefSalaryFile));
            Gson gson = new Gson();
            Type collectionType = new TypeToken<Collection<CoeffSalary>>() {
            }.getType();
        ...
        public EmployeeInformation generate(GenerationContext ctx) {
            ...
            String socialSecurityNumber = gender + yearBirth + monthBirth + departmentCode + commonBirth + orderBirth
                    + keySS;
            ...
            if (categoryLabel.toLowerCase().contains("cadre"))
