...
public class EmployeeInfoPayslipBox extends ElementBox {
    ...
    public EmployeeInfoPayslipBox(HorizontalContainer hcontainer) {
        this.hcontainer = hcontainer;
    }

    public EmployeeInfoPayslipBox(VerticalContainer container) {
        this.container = container;
    }

    public EmployeeInfoPayslipBox(PDFont font, PDFont fontB, float fontSize, PayslipModel model, PDDocument document)
            throws Exception {
        this.font = font;
        this.fontB = fontB;
    ...
    public VerticalContainer getEmployeeCodeBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getEmployeCodeLabel());
    ...
    public VerticalContainer getEmployeeRegNumberBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getRegistartionNumberLabel());
        // Label.setEntityName("ERNH");
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
        SimpleTextBox Value = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getRegistrationNumber());
    ...
    public VerticalContainer getEmployeeSucurityNumberBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getSecurityNumberLabel());
        // Label.setEntityName("SSNH");
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
        SimpleTextBox Value = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getSocialSecurityNumber());
    ...
    public VerticalContainer getEmployeeDateStartBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getDateStartLabel());
    ...
    public VerticalContainer getJobBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getEmploymentLabel());
    ...
    public VerticalContainer getReleaseDateBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getReleaseDateLabel());
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
    ...
    public VerticalContainer getClassificationBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getClassificationLabel());
        // Label.setEntityName("CLEH");
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
        SimpleTextBox Value = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getClassification());
    ...
    public VerticalContainer getSocialSecurityCeilingBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getSocialSecurityCeilingLabel());
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
        SimpleTextBox Value = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getSocialSecurityCeiling());
        // Value.setEntityName("S" + idName.toUpperCase());
        Value.setPadding(0, 0, 3, 0);
        companyIDContainer.addElement(Value);
    ...
    public VerticalContainer getHourlyRateBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getHourlyRateLabel());
    ...
    public VerticalContainer getDateSeniorityBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getDateSeniorityLabel());
        // Label.setEntityName("SDH");
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
        SimpleTextBox Value = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getDateSeniority());
    ...
    public VerticalContainer getMonthlyPayRefBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getMonthlyRefPayLabel());
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
        SimpleTextBox Value = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getMonthlyPayRef());
        // Value.setEntityName("S" + idName.toUpperCase());
        Value.setPadding(0, 0, 3, 0);
        companyIDContainer.addElement(Value);
    ...
    public VerticalContainer getMonthlyPayBlock() throws Exception {
        ...
        HorizontalContainer companyIDContainer = new HorizontalContainer(0, 0);
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getMonthlyPayLabel());
    ...
    public VerticalContainer getTimeTableBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getTimeTableLabel());
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
    ...
    public VerticalContainer getAssignementBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getAssignementLabel());
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
        SimpleTextBox Value = new SimpleTextBox(font, fontSize, 0, 0, model.getEmployeeInformation().getAssignment());
        // Value.setEntityName("S" + idName.toUpperCase());
    ...
    public VerticalContainer getCoefMinBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getMinCoeffLabel());
        Label.setPadding(0, 0, 2, 0);
        companyIDContainer.addElement(Label);
    ...
    public VerticalContainer getPeriodBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getPaymentPeriodLabel());
    ...
    public VerticalContainer getPaymentDateBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getPaymentDateLabel());
    ...
    public VerticalContainer getPaymentPeriodeDatesBlock() throws Exception {
        ...
        SimpleTextBox Label = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getPaymentPeriodDatesLabel());
        Label.setPadding(0, 0, 2, 0);
    ...
    public TableRowBox getEmployeeInformationTable5() throws Exception {
        ...
        listOptClasses.add("Qualif");
        firstPart2.addElement(new EmployeeInfoPayslipBox(concatContainersVertically(new ElementBox[] {
                getEmployeeSucurityNumberBlock(), emptyBox, getDateSeniorityBlock(), getClassificationBlock() })),
                false);
        listOptClasses.add("ESSN");
        listOptClasses.add("DateSeniority");
        listOptClasses.add("Classification");
    ...
    public TableRowBox getEmployeeInformationTable7() throws Exception {
        ...
        firstPart2.addElement(new EmployeeInfoPayslipBox(
                concatContainersVertically(new ElementBox[] { new HorizontalLineBox(0, 0, 550f, 0),
                        getAssignementBlock(), getJobBlock(), getCoeffBlock(), getClassificationBlock(),
                        new HorizontalLineBox(0, 0, 550f, 0), })),
                false);
        listOptClasses.add("Assignement");
        listOptClasses.add("Job");
        listOptClasses.add("Classification");
    ...
    public TableRowBox getEmployeeInformationTable8() throws Exception {
        ...
        idContainer.addElement(new HorizontalLineBox(0, 0, (configRow[0] + configRow[1] + configRow[2] + configRow[3]
                + configRow[4] + configRow[5] + configRow[6]), 0));

        // Ecquis
        SimpleTextBox Label4 = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getMinCoeffLabel());
        ...
        SimpleTextBox Value1 = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getCategoryLabel());
        ...
        SimpleTextBox Value2 = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getEchelonLabel());
        // Value.setEntityName("S" + idName.toUpperCase());
        ...
        SimpleTextBox Value6 = new SimpleTextBox(font, fontSize, 0, 0,
                model.getEmployeeInformation().getSocialSecurityNumber());
        ...
        SimpleTextBox Value11 = new SimpleTextBox(font, fontSize, 0, 0,
                Integer.toString(model.getRandom().nextInt(35)));
        // Value8.setEntityName("S" + idName.toUpperCase());
        ...
        idContainer.addElement(
                new VerticalLineBox(0, 0, (configRow[0] + configRow[1]), idContainer.getBBox().getHeight())); // sumUp.getBBox().getPosY()
        idContainer.addElement(new VerticalLineBox(0, 0, (configRow[0] + configRow[1] + configRow[2]),
                idContainer.getBBox().getHeight())); // sumUp.getBBox().getPosY()
        idContainer.addElement(new VerticalLineBox(0, 0, (configRow[0] + configRow[1] + configRow[2] + configRow[3]),
                idContainer.getBBox().getHeight())); // sumUp.getBBox().getPosY()
        idContainer.addElement(
                new VerticalLineBox(0, 0, (configRow[0] + configRow[1] + configRow[2] + configRow[3] + configRow[4]),
                        idContainer.getBBox().getHeight())); // sumUp.getBBox().getPosY()
        idContainer.addElement(new VerticalLineBox(0, 0,
                (configRow[0] + configRow[1] + configRow[2] + configRow[3] + configRow[4] + configRow[5]),
                idContainer.getBBox().getHeight())); // sumUp.getBBox().getPosY()
        idContainer.addElement(new VerticalLineBox(0, 0, (configRow[0] + configRow[1] + configRow[2] + configRow[3]
                + configRow[4] + configRow[5] + configRow[6]), idContainer.getBBox().getHeight())); // sumUp.getBBox().getPosY()

        // idContainer.addElement(new VerticalLineBox(0,0, 510f,
        // idContainer.getBBox().getHeight())); // sumUp.getBBox().getPosY()
