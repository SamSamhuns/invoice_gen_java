...
public class CompanyInfoBox extends ElementBox {
    ...
    public CompanyInfoBox(HorizontalContainer hcontainer) {
        this.hcontainer = hcontainer;
    }

    public CompanyInfoBox(VerticalContainer container) {
        this.container = container;
    }

    public CompanyInfoBox(PDFont font, PDFont fontB, float fontSize, Model model, PDDocument document)
            throws Exception {
        this.font = font;
        this.fontB = fontB;
