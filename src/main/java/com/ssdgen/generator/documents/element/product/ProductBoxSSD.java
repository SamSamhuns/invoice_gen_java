...
public class ProductBoxSSD extends ElementBox {
    ...
    public ProductBoxSSD(float posX, float posY, ProductContainer productContainer, PDFont font, PDFont fontB,
    ...
    private void init() throws Exception {
         ...
         * totalHT.addElement(new SimpleTextBox(font, fontSize, 0, 0, "", Color.BLACK,
         * null, HAlign.CENTER), false);
         * totalHT.addElement(new SimpleTextBox(font, fontSize, 0, 0, "", Color.BLACK,
         * null, HAlign.CENTER), false);
         * totalHT.addElement(new SimpleTextBox(font, fontSize, 0, 0, "", Color.BLACK,
         * null, HAlign.CENTER), false);
         * totalHT.addElement(new SimpleTextBox(fontB, fontSize+1, 0, 0,
         * productContainer.getTotalHead(), Color.BLACK, null, HAlign.LEFT), false);
         * totalHT.addElement(new SimpleTextBox(font, fontSize, 0, 0,
         * productContainer.getFmtTotal(), Color.BLACK, null, HAlign.CENTER , "TWTX"),
         * false);
         * 
