...
public class BDmobilierLayout implements InvoiceLayout {
    ...
    public void builtInvoice(InvoiceModel model, PDDocument document, XMLStreamWriter writer) throws Exception {
        ...
        String logo = this.getClass().getClassLoader().getResource("common/logo/fr/bdmobilier.png").getFile();
        ...
        infoCommande.addElement(new BorderBox(Color.WHITE,Color.WHITE,0,0,0,0,9));
        infoCommande.addElement(new SimpleTextBox(font,8,0,0,"Carrier : "));
        infoCommande.addElement(new SimpleTextBox(font,8,0,0,"Carrier 1"));
        ...
        firstLine.addElement(new SimpleTextBox(fontBold, 9, 0, 0, "Product / Reference",Color.WHITE,Color.BLACK), false);
        firstLine.addElement(new SimpleTextBox(fontBold, 9, 0, 0, "Unit Price",Color.WHITE,Color.BLACK), false);
        firstLine.addElement(new SimpleTextBox(fontBold, 9, 0, 0, "Discount",Color.WHITE,Color.BLACK), false);
        firstLine.addElement(new SimpleTextBox(fontBold, 9, 0, 0, "Quantity",Color.WHITE,Color.BLACK), false);
        ...
        for(int w=0; w< model.getProductContainer().getProducts().size(); w++) {
            ...
            productLine.addElement(new SimpleTextBox(font, 9, 2, 0, discount, "undefined"), false);
        ...
        lineLivraison.addElement(new SimpleTextBox(font, 9, 2, 0, "Shipping Cost",Color.BLACK,Color.LIGHT_GRAY), false);
