...
public class NatureDecouvertesLayout implements InvoiceLayout {
    ...
    public void builtInvoice(InvoiceModel model, PDDocument document, XMLStreamWriter writer) throws Exception {
        ...
        firstLine.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Product reference", Color.BLACK,null), true);
        firstLine.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Designation", Color.BLACK, null), true);
        firstLine.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Qty Order", Color.BLACK, null), true);
        firstLine.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "VAT", Color.BLACK, null), true);
        firstLine.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Unit Price ", Color.BLACK, null), true);
        firstLine.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Delivered quantity", Color.BLACK, null), true);
        firstLine.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Total Price", Color.BLACK,null), true);
        ...
        firstLineTax.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Code VAT", Color.BLACK,null), true);
        firstLineTax.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Base H.T", Color.BLACK, null), true);
        firstLineTax.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Rate %", Color.BLACK, null), true);
        firstLineTax.addElement(new SimpleTextBox(PDType1Font.HELVETICA_BOLD, 8, 0, 0, "Amount VAT", Color.BLACK, null), true);
